...
import MNIST.MLP_SECUENCIAL;

public class MainProbarMuestraSecuencial {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MLP_SECUENCIAL net = new MLP_SECUENCIAL();
            ...
            for (int epoch = 1; epoch <= epochs; epoch++) {
                ...
                for (int i = 0; i < train.getSize(); i++) {
                    double[] x = MLP_SECUENCIAL.normalize(train.getImage(i));
            ...
            System.out.println();
            System.out.println("========= TIEMPO TOTAL DE ENTRENAMIENTO - SECUENCIAL =========");
            ...
            double[] xTest = MLP_SECUENCIAL.normalize(test.getImage(indice));
...
//javac MNIST\*.java
//java -cp . MNIST.MainProbarMuestraSecuencial
