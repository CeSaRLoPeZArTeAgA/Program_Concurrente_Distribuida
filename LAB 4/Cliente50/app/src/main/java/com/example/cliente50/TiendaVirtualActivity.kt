...
class TiendaVirtualActivity : AppCompatActivity() {
    ...
    private fun volverAlChatAnterior() {
        ...
        val intent = Intent(this, MainActivity::class.java).apply {
            putExtra(MainActivity.EXTRA_QR_IP, prevIp)
            putExtra(MainActivity.EXTRA_QR_PORT, prevPort)
            putExtra(MainActivity.EXTRA_QR_AUTO_CONNECT, reconnectPrevious)
            putExtra(MainActivity.EXTRA_QR_SILENT_JOIN, false)
            putExtra(MainActivity.EXTRA_QR_CLONE_NAME, "")
